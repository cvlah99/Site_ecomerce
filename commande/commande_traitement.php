...
$stmt_commande = $pdo->prepare("INSERT INTO commandes (id_client, date_commande, statut, montant_total, adresse_livraison, note_commande)
                                VALUES (:id_client, CURDATE(), 'en attente', :montant_total, :adresse_livraison, :note_commande)");
